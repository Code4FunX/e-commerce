...
import AppleStoreIcon from '@/assets/app-store-icon.svg'
import { socialMedias } from './socialMedias'
import { NewsLetter } from './components/NewsLetter'
import { IFooterProps } from './components/types'
...
export const Footer = ({ showNewsLetter = true }: IFooterProps) => {
  return (
    <footer>
      ...
      <div className="custom-container grid gap-y-6 bg-white py-12  lg:grid-cols-7 lg:gap-x-10">
